...
router.get('/:conversationId/search', (req, res, next) => messageController.searchMessages(req, res, next));
router.get('/:conversationId/around/:messageId', (req, res, next) => messageController.getMessagesAround(req, res, next));
